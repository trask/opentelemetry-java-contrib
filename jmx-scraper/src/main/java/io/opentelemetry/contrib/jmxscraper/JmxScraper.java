...
public final class JmxScraper {
  ...
  public static void main(String[] args) {
    ...
    try {
      ...
      if (scraperConfig.getUsername() != null) {
        connectorBuilder.withUser(scraperConfig.getUsername());
      }
      if (scraperConfig.getPassword() != null) {
        connectorBuilder.withPassword(scraperConfig.getPassword());
      }
